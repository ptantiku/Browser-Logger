...
function formatTime(timestamp){
	...
	var datestr = zeroPad(dt.getDate()) + "/" 
...
<body>
	...
	<button id="clearall" onclick="document.location.href='clear.php';return false;">Clear All Data</button>
	<form name="postlog" method="post" action="submitted.php">
	<!-- Hidden Data -->
	<div class="hidden">
	...
	<input id="submit" name="submit" type="submit" class="button" value="Submit Logged Data" >
	</form>
</body>
</html>
